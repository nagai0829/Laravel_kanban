...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('scss/sign_in.css') }}">
    <link rel="stylesheet" href="{{ asset('scss/sign_up.css') }}">
    <link rel="stylesheet" href="{{ asset('scss/top.css') }}">
    <link rel="stylesheet" href="{{ asset('scss/header.css') }}">
    <link rel="stylesheet" href="{{ asset('scss/list_new.css') }}">
    <link rel="stylesheet" href="{{ asset('scss/list_edit.css') }}">
    <link rel="stylesheet" href="{{ asset('scss/card_new.css') }}">
    <link rel="stylesheet" href="{{ asset('scss/card_show.css') }}">
    <link rel="stylesheet" href="{{ asset('scss/card_edit.css') }}">
    <!-- <link rel="stylesheet" href="{{ asset('scss/.css') }}"> -->
    <link rel="stylesheet" href="{{ asset('scss/button.css') }}">
